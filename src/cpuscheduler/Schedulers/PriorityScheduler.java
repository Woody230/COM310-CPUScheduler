...
public class PriorityScheduler extends Scheduler 
{
    ...
    public void setProcessOrderAndTimes() 
    {
        ...
        //Need a deep copy since processes will get sorted by priority, and not the natural ordering of PID.
        queue.setListOfProcesses(ProcessList.getListOfProcessesDeepCopy(super.getProcessList().getListOfProcesses()));
        queue.sortListOfProcessesByPriority();
        
        times.add(0);
        
        //Since the queue has been sorted by priority, the algorithm now effectively functions like FCFS.
